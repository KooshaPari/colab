// Bug fix. adds empty 'moves' array to the result of a computedDiff so monaco doesn't crash
...
(() => {
  ...
  var isElectronProcess =
    typeof ((_a =
      nodeProcess === null || nodeProcess === void 0 ? void 0 : nodeProcess.versions) === null ||
    _a === void 0
      ? void 0
      : _a.electron) === "string";
  ...
  var Emitter = class {
    constructor(options) {
      ...
      this._leakageMon =
        ...
        ((_a3 = this._options) === null || _a3 === void 0 ? void 0 : _a3.leakWarningThreshold)
          ? new LeakageMonitor(
              (_c =
    ...
    get event() {
      if (!this._event) {
        this._event = (callback, thisArgs, disposables) => {
          ...
          if (
            firstListener &&
            ((_a3 = this._options) === null || _a3 === void 0 ? void 0 : _a3.onWillAddFirstListener)
          ) {
          ...
          const result = listener.subscription.set(() => {
            ...
            if (!this._disposed) {
              (_b2 =
                (_a4 = this._options) === null || _a4 === void 0
                  ? void 0
                  : _a4.onWillRemoveListener) === null || _b2 === void 0
                ? void 0
                : _b2.call(_a4, this);
              removeListener();
      ...
      if (this._listeners) {
        if (!this._deliveryQueue) {
          this._deliveryQueue = new PrivateEventDeliveryQueue(
            (_a3 = this._options) === null || _a3 === void 0 ? void 0 : _a3.onListenerError,
          );
        }
    ...
    _handleRequestMessage(requestMessage) {
      ...
      result.then(
        ...
        (e) => {
          ...
          this._send(
            new ReplyMessage(this._workerId, req, void 0, transformErrorForSerialization(e)),
          );
        },
      );
    }
  ...
  function uriToFsPath(uri, keepDriveLetterCasing) {
    ...
    if (uri.authority && uri.path.length > 1 && uri.scheme === "file") {
      ...
      ((uri.path.charCodeAt(1) >= 65 && uri.path.charCodeAt(1) <= 90) ||
        (uri.path.charCodeAt(1) >= 97 && uri.path.charCodeAt(1) <= 122)) &&
  ...
  var LinkComputer = class {
    static _createLink(classifier, line, lineNumber, linkBeginIndex, linkEndIndex) {
      ...
      if (linkBeginIndex > 0) {
        ...
        if (
          (charCodeBeforeLink === 40 && lastCharCodeInLink === 41) ||
  ...
  (function (SignatureHelpTriggerKind3) {
    ...
    SignatureHelpTriggerKind3[(SignatureHelpTriggerKind3["TriggerCharacter"] = 2)] =
      "TriggerCharacter";
  ...
  (function (CompletionItemInsertTextRule2) {
    ...
    CompletionItemInsertTextRule2[(CompletionItemInsertTextRule2["KeepWhitespace"] = 1)] =
      "KeepWhitespace";
    CompletionItemInsertTextRule2[(CompletionItemInsertTextRule2["InsertAsSnippet"] = 4)] =
      "InsertAsSnippet";
  ...
  (function (CompletionTriggerKind2) {
    ...
    CompletionTriggerKind2[(CompletionTriggerKind2["TriggerForIncompleteCompletions"] = 2)] =
  ...
  (function (EditorOption2) {
    EditorOption2[(EditorOption2["acceptSuggestionOnCommitCharacter"] = 0)] =
    ...
    EditorOption2[(EditorOption2["screenReaderAnnounceInlineSuggestion"] = 6)] =
    ...
    EditorOption2[(EditorOption2["copyWithSyntaxHighlighting"] = 23)] =
      "copyWithSyntaxHighlighting";
    EditorOption2[(EditorOption2["cursorBlinking"] = 24)] = "cursorBlinking";
    EditorOption2[(EditorOption2["cursorSmoothCaretAnimation"] = 25)] =
    ...
    EditorOption2[(EditorOption2["cursorSurroundingLinesStyle"] = 28)] =
    ...
    EditorOption2[(EditorOption2["disableMonospaceOptimizations"] = 31)] =
    ...
    EditorOption2[(EditorOption2["experimentalWhitespaceRendering"] = 36)] =
    ...
    EditorOption2[(EditorOption2["unfoldOnClickAfterEndOfLine"] = 46)] =
    ...
    EditorOption2[(EditorOption2["mouseWheelScrollSensitivity"] = 72)] =
      "mouseWheelScrollSensitivity";
    EditorOption2[(EditorOption2["mouseWheelZoom"] = 73)] = "mouseWheelZoom";
    EditorOption2[(EditorOption2["multiCursorMergeOverlapping"] = 74)] =
    ...
    EditorOption2[(EditorOption2["renderLineHighlightOnlyWhenFocus"] = 92)] =
      "renderLineHighlightOnlyWhenFocus";
    EditorOption2[(EditorOption2["renderValidationDecorations"] = 93)] =
      "renderValidationDecorations";
    EditorOption2[(EditorOption2["renderWhitespace"] = 94)] = "renderWhitespace";
    EditorOption2[(EditorOption2["revealHorizontalRightPadding"] = 95)] =
    ...
    EditorOption2[(EditorOption2["suggestOnTriggerCharacters"] = 116)] =
    ...
    EditorOption2[(EditorOption2["wordWrapBreakAfterCharacters"] = 127)] =
      "wordWrapBreakAfterCharacters";
    EditorOption2[(EditorOption2["wordWrapBreakBeforeCharacters"] = 128)] =
  ...
  (function (OverlayWidgetPositionPreference2) {
    OverlayWidgetPositionPreference2[(OverlayWidgetPositionPreference2["TOP_RIGHT_CORNER"] = 0)] =
      "TOP_RIGHT_CORNER";
    OverlayWidgetPositionPreference2[
      (OverlayWidgetPositionPreference2["BOTTOM_RIGHT_CORNER"] = 1)
    ] = "BOTTOM_RIGHT_CORNER";
    OverlayWidgetPositionPreference2[(OverlayWidgetPositionPreference2["TOP_CENTER"] = 2)] =
      "TOP_CENTER";
  ...
  (function (TrackedRangeStickiness2) {
    TrackedRangeStickiness2[(TrackedRangeStickiness2["AlwaysGrowsWhenTypingAtEdges"] = 0)] =
      "AlwaysGrowsWhenTypingAtEdges";
    TrackedRangeStickiness2[(TrackedRangeStickiness2["NeverGrowsWhenTypingAtEdges"] = 1)] =
      "NeverGrowsWhenTypingAtEdges";
    TrackedRangeStickiness2[(TrackedRangeStickiness2["GrowsOnlyWhenTypingBefore"] = 2)] =
      "GrowsOnlyWhenTypingBefore";
    TrackedRangeStickiness2[(TrackedRangeStickiness2["GrowsOnlyWhenTypingAfter"] = 3)] =
    ...
    shouldHighlightNonBasicASCII(character, wordContext) {
      ...
      if (wordContext) {
        for (const char of wordContext) {
          ...
          if (
            !isBasicASCII2 &&
            !this.ambiguousCharacters.isAmbiguous(codePoint2) &&
            !InvisibleCharacters.isInvisibleCharacter(codePoint2)
          ) {
    ...
    computeDiff(originalLines, modifiedLines, options) {
      ...
      for (const c of result.changes) {
        ...
        let change = new LineRangeMapping(
          originalRange,
          modifiedRange,
          (_a3 = c.charChanges) === null || _a3 === void 0
            ? void 0
            : _a3.map(
                (c2) =>
                  new RangeMapping(
        ...
        return checkAdjacentItems(
          ...
          (m1, m2) =>
            m2.originalRange.startLineNumber - m1.originalRange.endLineNumberExclusive ===
              m2.modifiedRange.startLineNumber - m1.modifiedRange.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    ...
    for (let i = 1; i < sequenceDiffs.length; i++) {
      ...
      if (cur.seq1Range.isEmpty) {
        ...
        for (let i2 = 1; i2 <= length; i2++) {
          if (
            sequence2.getElement(cur.seq2Range.start - i2) !==
            sequence2.getElement(cur.seq2Range.endExclusive - i2)
          ) {
            all = false;
            break;
          }
        ...
        if (
          ...
          if (
            ...
            lastModifiedWord.deleted +=
              (_a3 = s1Added === null || s1Added === void 0 ? void 0 : s1Added.length) !== null &&
              _a3 !== void 0
                ? _a3
                : 0;
  ...
  var EditorSimpleWorker = class {
    ...
    static computeDiff(originalTextModel, modifiedTextModel, options, algorithm) {
      ...
      return {
        ...
        // Note (yoav): there's a bug in monaco
        // that expects moves to be an array
        // and crashes computing the diff otherwise
        moves: [],
        changes: result.changes.map((m) => {
          ...
          return [
            ...
            (_a3 = m.innerChanges) === null || _a3 === void 0
              ? void 0
              : _a3.map((m2) => [
