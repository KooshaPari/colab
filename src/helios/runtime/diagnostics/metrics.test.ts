...
describe('RuntimeMetrics', () => {
  ...
  describe('getReport()', () => {
    ...
    it('includes correct unit in summaries', () => {
      ...
      const countSummary = report.summaries.find(s => s.metric === 'terminal_output_backlog_depth');
  ...
  describe('integration scenarios', () => {
    ...
    it('handles mixed tags from records and timers', () => {
      ...
      vi.setSystemTime(1100);
      const timerSample = metrics.endTimer('session_restore_latency_ms', 'restore-1', { 'result': 'success' });
