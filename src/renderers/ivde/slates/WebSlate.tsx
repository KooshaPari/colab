...
import type { CachedFileType, PreviewFileTreeType } from "../../../shared/types/types";
...
`;
  ...
  const onUrlInputKeyDown = (e: DomEventWithTarget<KeyboardEvent, HTMLInputElement>) => {
    if (e.key === "Enter") {
  ...
  return (
    ...
    >
      <div style="display: flex; box-sizing: border-box; gap: 5px; padding: 10px; min-height: 40px;height: 40px; width: 100%;overflow-x:hidden;">
        <button class="browser-btn" disabled={isBackDisabled()} type="button" onClick={onClickBack}>
          <img width="16" height="16" src={`views://assets/file-icons/browser-back.svg`} />
        </button>
        <button
          ...
          class="browser-btn"
        >
          <img width="16" height="16" src={`views://assets/file-icons/browser-forward.svg`} />
        </button>
        <button class="browser-btn" type="button" onClick={onClickReload}>
          <img width="12" height="12" src={`views://assets/file-icons/browser-reload.svg`} />
        </button>

        <button class="browser-btn" type="button" onClick={onClickHome}>
          <img width="12" height="12" src={`views://assets/file-icons/browser-home.svg`} />
        </button>
            ...
            return (
              ...
              >
                <Show when={state.downloadNotification?.status === "downloading"}>
                  ...
                  >
                    {/* Background circle */}
                    <circle cx="9" cy="9" r="7" fill="none" stroke="#555" stroke-width="2" />
                    {/* Progress circle */}
                    <circle
                      cx="9"
                      cy="9"
        ...
        <Show when={isRealNode()}>
          ...
          >
            <img width="12" height="12" src={`views://assets/file-icons/browser-script.svg`} />
          </button>
        </Show>
      </div>
