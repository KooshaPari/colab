...
export const GitSlate = ({ node }: { node?: CachedFileType }) => {
    ...
    if (relPath) {
      try {
        ...
        if (isFromStaged !== undefined) {
          ...
          isStaged = !isUnstaged;
          console.log(
            `Detected staged status: ${isStaged} for ${relPath} (unstaged: ${isUnstaged})`,
          );
        }
  ...
  const validateBranchName = (name: string): { isValid: boolean; error?: string } => {
    ...
    if (invalidChars.test(name)) {
      return {
        isValid: false,
        error: "Branch name cannot contain spaces or special characters (~^:\\?*[)",
      };
    }
  ...
  const validateRemoteUrl = (url: string): { isValid: boolean; error?: string } => {
    ...
    if (!isValidUrl) {
      return {
        isValid: false,
        error: "Invalid URL format (must start with https://, git@, ssh://, or file://)",
      };
    }
      ...
      onConfirm: async () => {
        ...
        try {
          if (change.changeType === "?" || change.changeType === "A") {
            ...
            const fullPath = filePath.startsWith("/") ? filePath : `${repoRootPath}/${filePath}`;
            ...
            const output =
              typeof result === "string" ? result : result?.stdout || result?.stderr || "";
                  ...
                  <div style={{ "margin-bottom": "8px" }}>
                    ...
                    <input
                      ...
                      style={{
                        width: "100%",
                        background: "#3c3c3c",
                        border: subjectLength() > 50 ? "1px solid #f87171" : "1px solid #464647",
                        "border-radius": "2px",
                        color: "#cccccc",
                        outline: "none",
                        "font-family": "'Segoe UI', system-ui, sans-serif",
                  ...
                  >
                    ...
                    <Show when={uiState.syncStatus.ahead > 0}>
                      <span
                        style={{
                          color: "#4ade80",
                          "margin-left": uiState.syncStatus.behind > 0 ? "4px" : "0",
                        }}
                      >
                        ↑{uiState.syncStatus.ahead}
                      </span>
                    </Show>
                  </span>
                </Show>
                    ...
                    onClick={async () => {
                      ...
                      if (isAltPressed()) {
                        setDialogConfig({
                          ...
                          message:
                            "Force push will overwrite the remote branch history. This can cause data loss for other collaborators. Are you sure you want to continue?",
                      ...
                      >
                        ...
                        >
                          ...
                          <Show
                            when={
                              !commit.isRemoteOnly &&
                              index() === uiState.log.findIndex((c) => !c.isRemoteOnly)
                            }
                          >
                            <button
                              style={{
          ...
          >
            ...
            >
              <div style={{ display: "flex", gap: "8px", "align-items": "center" }}>
                ...
                >
                  BRANCHES (
                  {uiState.branches?.all?.filter((b) => !b.includes("remotes/")).length || 0})
                </button>
                <button
                  style={{
            ...
            >
                ...
                <div style={{ padding: "8px 0" }}>
                  ...
                  <Show
                    when={
                      ...
                      !uiState.branches.all.includes(uiState.branches.current)
                    }
                  >
                    <div
                      style={{
                      ...
                      {(branch) => {
                        ...
                        return (
                          <div
                            ...
                            onMouseLeave={(e) =>
                              !isCurrent && (e.currentTarget.style.background = "transparent")
                            }
                          >
                            <div style={{ display: "flex", "align-items": "center", gap: "8px" }}>
                              <div
                      ...
                      fallback={
                        <div style={{ display: "flex", "flex-direction": "column", gap: "6px" }}>
                          <input
                            ...
                            onBlur={(e) => {
                              e.currentTarget.style.borderColor = "#094771";
                            }}
                            onKeyDown={(e) => {
                              if (e.key === "Enter") {
                                e.preventDefault();
                          ...
                          <Show
                            when={
                              branchInputValue().trim() &&
                              !validateBranchName(branchInputValue()).isValid
                            }
                          >
                            <div
                              style={{
                          ...
                          <div style={{ display: "flex", gap: "6px" }}>
                            <button
                              style={{
                                background: validateBranchName(branchInputValue()).isValid
                                  ? "#094771"
                                  : "#333",
                                border: "1px solid #094771",
                                color: validateBranchName(branchInputValue()).isValid
                                  ? "#fff"
                                  : "#999",
                                "font-size": "10px",
                                "font-weight": "600",
                                padding: "4px 8px",
                                "border-radius": "3px",
                                cursor: validateBranchName(branchInputValue()).isValid
                                  ? "pointer"
                                  : "not-allowed",
                                "font-family": "'Segoe UI', system-ui, sans-serif",
                                flex: 1,
                  ...
                  <Show when={showRemoteInput()}>
                    ...
                    >
                      <div style={{ "margin-bottom": "8px" }}>
                        ...
                        <Show
                          when={
                            remoteUrlValue().trim() && !validateRemoteUrl(remoteUrlValue()).isValid
                          }
                        >
                          <div
                            style={{
                      ...
                      <div style={{ display: "flex", gap: "6px" }}>
                        <button
                          style={{
                            background:
                              validateRemoteName(remoteNameValue()).isValid &&
                              validateRemoteUrl(remoteUrlValue()).isValid
                                ? "#094771"
                                : "#333",
                            border: "1px solid #094771",
                            color:
                          ...
                          <div style={{ "border-bottom": "1px solid #2d2d2d" }}>
                            ...
                            <Show when={isExpanded()}>
                              <div style={{ "padding-left": "32px", background: "#1e1e1e" }}>
                                <For
                                  each={uiState.branches.remote.filter((b: string) =>
                                    b.includes(`remotes/${remote.name}/`),
                                  )}
                                >
                                  {(branch) => {
                                                ...
                                                onClick={async (e) => {
                                                  ...
                                                  try {
                                                    if (hasLocalBranch) {
                                                      ...
                                                      console.log(
                                                        "Switched to local tracking branch, refreshing status...",
                                                      );
                                                    } else {
                                                      ...
                                                      console.log(
                                                        "Created tracking branch, refreshing status...",
                                                      );
                                                    }
                                                    ...
                                                    await getLogAndStatus();
                                                    console.log(
                                                      "Status refreshed after branch operation",
                                                    );
                                                  } catch (error) {
                                                    console.error(
                                                      `Failed to ${buttonText} branch:`,
                                                      error,
                                                    );
                                                    showErrorDialog(
                                                      `${buttonText.charAt(0).toUpperCase() + buttonText.slice(1)} Failed`,
                                                      error,
                                                    );
                                                  }
                                                }}
              ...
              <Show when={uiState.activeSection === "stashes"}>
                <div>
                  ...
                  <div style={{ padding: "4px 12px", color: "#ff0", "font-size": "10px" }}></div>
                                  ...
                                  <For each={stashFiles()[stashName] || []}>
                                    {(file) => (
                                      ...
                                      >
                                        ...
                                        <span style={{ color: "#cccccc" }}>{file.relPath}</span>
                                      </div>
                                    )}
                                  </For>
                                </Show>
        ...
        >
          <DiffEditor
            ...
            canStageLines={(() => {
              ...
              console.log(
                "GitSlate: canStageLines =",
                canStage,
                "commitHash =",
                selectedFile().commitHash,
              );
              return canStage;
            })()}
            filePath={(() => {
...
const ChangeTypeSpan = ({ changeType }: { changeType: FileChangeType["changeType"] }) => {
